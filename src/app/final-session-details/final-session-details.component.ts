...
@Component({
  selector: 'app-final-session-details',
  templateUrl: './final-session-details.component.html',
  styleUrls: ['./final-session-details.component.css'],
...
export class FinalSessionDetailsComponent implements OnInit {
